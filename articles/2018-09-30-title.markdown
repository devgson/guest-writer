...
* Then click on the **Create Database** button, select the **Start in public mode** option and create the database.
...
Open up your terminal in your project directory and set your project environmental variables. Replace the values below with your Auth0 application's `domain` and `audience` values. On a windows based system, you can set environmental variables using `set` in place of `export`
